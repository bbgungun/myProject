...
<body class="signin" style="height: 100vh">
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      ...
      <a href="<%=basePath %>jsp/register.jsp" style="float:right"><button class="btn btn-primary">注册</button></a>
    </div>
  </nav>
  <div class="container" style="/* min-height: 100vh */">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
          <form action="<%= basePath %>user/login.do" method="get" class="form-signin" id="loginform" style="padding: 0 30px;">
            <h2 class="form-signin-heading">Sign in</h2>
            <label for="username" class="sr-only">ID</label>
            <input type="text" id="username" class="form-control" placeholder="ID" name="userName" required="">
